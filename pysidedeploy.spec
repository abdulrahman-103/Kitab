...
project_dir = C:\Users\Abdulrahman\kitab

# source file entry point path. default = main.py
input_file = src\kitab\main.py

# directory where the executable output is generated
exec_directory = C:\Users\Abdulrahman\kitab\build

# path to the project file relative to project_dir
project_file = 

# application icon
icon = resources/icons/kitab.ico

[python]

# python path
python_path = C:\Users\Abdulrahman\AppData\Local\Programs\Python\Python313\python.exe
...
extra_args = --quiet --windows-console-mode=disable
