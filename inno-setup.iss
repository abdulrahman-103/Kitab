...
#define MyAppName "Kitab"
#define MyAppVersion "0.3.0"
#define MyAppPublisher "Abdulrahman 103"
#define MyAppURL "https://github.com/abdulrahman-103/kitab"
#define MyAppExeName "main.exe"
#define MyAppAssocExt ".ktb"
#define MyAppAssocKey "KitabDocument"
...
AppId={{8943368B-0386-459A-BBD0-8C5FBB694AD6}
...
LicenseFile=C:\Users\Abdulrahman\kitab\LICENSE
; Uncomment the following line to run in non administrative install mode (install for current user only).
;PrivilegesRequired=lowest
OutputBaseFilename=kitab
SetupIconFile=C:\Users\Abdulrahman\kitab\resources\icons\kitab.ico
...
[CustomMessages]
english.MyAppName=Kitab
arabic.MyAppName=كتاب

english.MyAppAssocName=Kitab Document
arabic.MyAppAssocName=مستند كتاب

[Tasks]
Name: "desktopicon"; Description: "{cm:CreateDesktopIcon}"; GroupDescription: "{cm:AdditionalIcons}"; Flags: unchecked

[Files]
Source: "C:\Users\Abdulrahman\kitab\build\Kitab.dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Abdulrahman\kitab\build\Kitab.dist\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "C:\Users\Abdulrahman\kitab\resources\*"; DestDir: "{app}\resources"; Flags: ignoreversion recursesubdirs createallsubdirs
; NOTE: Don't use "Flags: ignoreversion" on any shared system files.

[Registry]
Root: HKA; Subkey: "Software\Classes\{#MyAppAssocExt}\OpenWithProgids"; ValueType: string; ValueName: "{#MyAppAssocKey}"; ValueData: ""; Flags: uninsdeletevalue
Root: HKA; Subkey: "Software\Classes\{#MyAppAssocKey}"; ValueType: string; ValueName: ""; ValueData: "{cm:MyAppAssocName}"; Flags: uninsdeletekey
